  ...
  return (
    <div className="space-y-6">
      ...
      <div className="overflow-hidden rounded-2xl bg-white">
        {/* Header row */}
        {/* Header aligned to the same column widths as item rows */}
        <div className="grid [grid-template-columns:36px_1fr_160px_120px_120px_140px_40px] items-center gap-x-8 border-b px-5 py-3 text-sm text-gray-700 rounded-full bg-neutral-100 font-medium">
          ...
          {/* Empty cells to reserve space for actions and heart (align columns) */}
          <div></div>
          <div></div>
        </div>

        {filtered.map((it) => (
          <div key={it.id} className="px-3 py-2 border-b last:border-b-0">
            {/* Shop name row */}
            <div className="px-3 pb-2 text-sm text-gray-700 font-medium">
              {it.shopName}
            </div>
            {/* Item row box */}
            <div className="grid [grid-template-columns:36px_1fr_160px_120px_120px_140px_40px] items-center gap-x-8 rounded-xl border border-gray-200 bg-white px-5 py-4">
              ...
              <div className="flex items-center gap-3 min-w-0">
                <div className="h-14 w-14 overflow-hidden rounded bg-gray-100 shrink-0">
